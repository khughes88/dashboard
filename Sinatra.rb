...
data["jiracurve_guide"] = []
  data["jiracurveurl" ]= "https://jiraserver/jira/secure/IssueNavigator!executeAdvanced.jspa?jqlQuery=project=0000 AND backlog='' AND type='5' AND status!='Closed'&runQuery=true&clear=true"
data["jiradefectsurl"] = "https://jiraserver/jira/secure/IssueNavigator!executeAdvanced.jspa?jqlQuery=project=0000 AND fixVersion='CDT-R3-Backlog' AND type='5' AND status!='Closed'&runQuery=true&clear=true"
